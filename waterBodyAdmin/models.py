...
class WaterBodyBasicDetailResponse(models.Model):
    id = models.UUIDField(primary_key=True,default=uuid4)
    surveyResponse = models.ForeignKey(WaterBodySurveyResponse,on_delete=models.CASCADE,related_name='BasicDetail')
    ...
    waterbodytype = models.ForeignKey(WaterBodyType,on_delete=models.CASCADE)
    ownership = models.ForeignKey(WaterBodyOwnerShip,on_delete=models.CASCADE)
    createdBy = models.CharField(max_length=255)
    createdDate = models.DateTimeField(auto_now_add=True)
    lastModifiedBy = models.CharField(max_length=255,blank=True)
    lastModifiedDate = models.DateTimeField(auto_now=True)
...
class WaterBodyFreeCatchmentResponse(models.Model):
    ...
    seassonstart = models.ForeignKey(Month,on_delete=models.CASCADE,related_name='seassonstart')
    seassonend = models.ForeignKey(Month,on_delete=models.CASCADE,related_name='seassonend')
...
class WaterBodySluiceUpStreamResponse(models.Model):
    id = models.UUIDField(primary_key=True,default=uuid4)
    surveyResponse = models.ForeignKey(WaterBodySurveyResponse,on_delete=models.CASCADE,related_name='SluiceUpStream')
    tankName = models.CharField(max_length=255)
    tankSluiceNumber = models.IntegerField()
    sourcecontributiontype = models.CharField(max_length=255)
    contributiontypepercentage = models.IntegerField()
    seassonstart = models.ForeignKey(Month,on_delete=models.CASCADE,related_name='sluiceseassonstart')
    seassonend = models.ForeignKey(Month,on_delete=models.CASCADE,related_name='sluiceseassonend')
    streamtype = models.ForeignKey(WaterBodyCrossSection,on_delete=models.CASCADE)
    actualbreadth = models.IntegerField()
    currentbreadth = models.IntegerField()
    actualbottomwidth = models.IntegerField()
...
class WaterBodyIrrigationCanalResponse(models.Model):
    ...
    firstseassonstart = models.ForeignKey(Month,on_delete=models.CASCADE,related_name='irrigationfirstseassonstart')
    firstseassonend = models.ForeignKey(Month,on_delete=models.CASCADE,related_name='irrigationfirstseassonend')
    secondseassonstart = models.ForeignKey(Month,on_delete=models.CASCADE,related_name='irrigationsecondseassonstart')
    secondseassonend = models.ForeignKey(Month,on_delete=models.CASCADE,related_name='irrigationsecondseassonend')
    contributiontypepercentage = models.IntegerField()
    streamtype = models.ForeignKey(WaterBodyCrossSection,on_delete=models.CASCADE)
...
class WaterBodySpreadResponse(models.Model):
    ...
    speciesName = models.ForeignKey(WaterBodyExoticSpecies,on_delete=models.CASCADE,related_name='ExoticSpecies')
...
class WaterBodySpreadIssues(models.Model):
    id = models.UUIDField(primary_key=True,default=uuid4)
    spreadResponse = models.ForeignKey(WaterBodySpreadResponse,on_delete=models.CASCADE,related_name='Issues')
...
class WaterBodyBundIssues(models.Model):
    id = models.UUIDField(primary_key=True,default=uuid4)
    bundResponse = models.ForeignKey(WaterBodyBundResponse,on_delete=models.CASCADE,related_name='Issues')
    issue = models.ForeignKey(WaterBodyStreamIssues,on_delete=models.CASCADE)
    createdBy = models.CharField(max_length=255)
    createdDate = models.DateTimeField(auto_now_add=True)
    lastModifiedBy = models.CharField(max_length=255,blank=True)
